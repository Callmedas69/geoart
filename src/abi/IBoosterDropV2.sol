...
interface IBoosterDropV2 {
    ...
    event BoosterDropsMinted(
        address indexed minter,
        uint256 amount,
        uint256 startTokenId,
        uint256 endTokenId
    );
    event BoosterDropTransfer(
        address indexed from,
        address indexed to,
        uint256 tokenId
    );
    event BoosterDropSold(
        address indexed burner,
        uint256 tokenId,
        uint8 rarity,
        uint256 offerAmount
    );
    event BoosterDropSoldBatch(
        address indexed burner,
        uint256[] tokenIds,
        uint8[] rarities,
        uint256 finalOfferAmount
    );
    event BoosterDropOpened(
        address indexed from,
        uint256[] tokenIds,
        uint256 batchId
    );
    ...
    /**
     * @notice Get the offer amount for a mythic rarity NFT
    ...
    function getTokenRarity(
        uint256 tokenId
    ) external view returns (Rarity memory rarityInfo);
}
